...
<div class="container">
    <form:form action = "registerUser" method="post" modelAttribute="student" class="form-signin">
        ...
        <div class="form-group row">
            <span>${genericError}</span><i class="fas fa-exclamation-triangle"></i>
        ...
        <div class="form-group row">
            ...
            <form:input type="userName" path="userName" class="col-sm-4" placeholder="userName"
                        autofocus="true"></form:input>
            <form:errors path="userName" element = "div" cssClass="error"><i class="fas fa-exclamation-triangle"></i></form:errors>
        </div>
        <div class= "form-group row">
